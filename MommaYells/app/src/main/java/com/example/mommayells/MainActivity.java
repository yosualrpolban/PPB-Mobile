...
//        });
        ...
        final ScheduleListAdapter adapter = new ScheduleListAdapter(new ScheduleListAdapter.ScheduleDiff());
...
//    String jsonData = "[{'scheduleName':'Makan'}," +
//                "{'scheduleName': 'Beresin PPB'}," +
//                "{'scheduleName': 'Ketemu Putin'}]";
//        setData(jsonData);
//
//        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerview);
//        mAdapter = new ScheduleListAdapter(scheduleArrayList);
//
//        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(MainActivity.this);
//        mRecyclerView.setLayoutManager(layoutManager);
//        mRecyclerView.setAdapter(mAdapter);
////        for (int i = 0; i < 20; i++) {
////            mScheduleList.addLast("Schedule " + i);
////        }
//
//
//    }
...
////                Schedule player = new Schedule(jsonObject.getString("scheduleName"));
////                        jsonObject.getString("position"),
////                        jsonObject.getInt("number"));
//
////                scheduleArrayList.add(player);
//            }
//
